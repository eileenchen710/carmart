<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:86:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/shop_home.html";i:1510020954;s:81:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/base.html";i:1509883700;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/header_top.html";i:1509883700;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/shop_apply.html";i:1509883698;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/right_cart.html";i:1509883698;s:83:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/footer.html";i:1509883700;}*/ ?>
<!doctype html>
<head>
		...
		<div class="wst-shop-nav">
			<div class="wst-nav-box">
				...
				<?php if(is_array($data['shopcats']) || $data['shopcats'] instanceof \think\Collection): $i = 0;$__LIST__ = is_array($data['shopcats']) ? array_slice($data['shopcats'],0,8, true) : $data['shopcats']->slice(0,8, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sc): $mod = ($i % 2 );++$i;?>
					<a href="<?php echo url('home/shops/home',array('shopId'=>$sc['shopId'],'ct1'=>$sc['catId'])); ?>"><li class="liselect wst-lfloat <?php if($ct1 == $sc['catId']): ?>wst-nav-boxa<?php endif; ?>"><?php echo $sc['catName']; ?></li></a>
...
<div class="wst-container">
	<div class="wst-shop-contl">
		<div class="wst-shop-cat">
			...
			<?php if(is_array($data['shopcats']) || $data['shopcats'] instanceof \think\Collection): $i = 0; $__LIST__ = $data['shopcats'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sc1): $mod = ($i % 2 );++$i;?>
				...
				<?php if(is_array($sc1['children']) || $sc1['children'] instanceof \think\Collection): $i = 0; $__LIST__ = $sc1['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sc2): $mod = ($i % 2 );++$i;?>
					<a href="<?php echo url('home/shops/home',array('shopId'=>$sc1['shopId'],'ct1'=>$sc1['catId'],'ct2'=>$sc2['catId'])); ?>"><li><?php echo WSTMSubstr($sc2['catName'],0,15); ?></li></a>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<?php endif; endforeach; endif; else: echo "" ;endif; ?>
			</div>
		...
		<div class="wst-shop-best">
			...
			<?php $wstTagShopGoods =  model("Tags")->listShopGoods("hot",$data['shop']['shopId'],5,0); foreach($wstTagShopGoods as $key=>$ho){?>
		...
		<div class="wst-shop-lat">
			...
			<?php $wstTagGoods =  model("Tags")->listGoods("history",0,4,0); foreach($wstTagGoods as $key=>$vo){?>
			<div class="wst-shop-bestg">
	...
	<div class="wst-shop-contr">
		<div class="wst-shop-rec">
			...
			<div class="wst-shop-recb">
			    <?php $wstTagShopGoods =  model("Tags")->listShopGoods("recom",$data['shop']['shopId'],4,0); foreach($wstTagShopGoods as $key=>$re){?>
