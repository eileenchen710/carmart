<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:88:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/shops/index.html";i:1523516678;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/shops/base.html";i:1524642472;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/header_top.html";i:1524642623;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/shop_apply.html";i:1523516678;s:83:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/footer.html";i:1524642623;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>卖家中心 - <?php echo WSTConf('CONF.mallName'); ?><?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-shop-info">
	<span class="wst-shop-img">
	  <a href="<?php echo url('home/shops/home',array('shopId'=>$data['shop']['shopId'])); ?>">
	  <img src="__ROOT__/<?php echo WSTImg($data['shop']['shopImg']); ?>" title="<?php echo $data['shop']['shopName']; ?>" alt="<?php echo $data['shop']['shopName']; ?>">
	  </a>
	</span>
	<div class="wst-shop-na">
		<p><a href='<?php echo Url("home/shops/home","shopId=".$data["shop"]["shopId"]); ?>'><?php echo WSTMSubstr($data['shop']['shopName'],0,10); ?></a></p>
		<div class="wst-shop-na2">
		<?php if(is_array($data['shop']['accreds']) || $data['shop']['accreds'] instanceof \think\Collection): $i = 0; $__LIST__ = $data['shop']['accreds'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
		<img src="__ROOT__/<?php echo $v['accredImg']; ?>"><span><?php echo $v['accredName']; ?></span>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
	...
	<div class="wst-shop-eva">
		...
		<?php $__FOR_START_629705200__=0;$__FOR_END_629705200__=$data['shop']['scores']['goodsScore'];for($i=$__FOR_START_629705200__;$i < $__FOR_END_629705200__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_1589072199__=1;$__FOR_END_1589072199__=6-$data['shop']['scores']['goodsScore'];for($i=$__FOR_START_1589072199__;$i < $__FOR_END_1589072199__;$i+=1){ ?>
	...
	<div class="wst-shop-eva">
		<p>时效评分</p>
		<div class="wst-shop-evai">
		<?php $__FOR_START_1593161677__=0;$__FOR_END_1593161677__=$data['shop']['scores']['timeScore'];for($i=$__FOR_START_1593161677__;$i < $__FOR_END_1593161677__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_1901401362__=1;$__FOR_END_1901401362__=6-$data['shop']['scores']['timeScore'];for($i=$__FOR_START_1901401362__;$i < $__FOR_END_1901401362__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-off.png">
		<?php } ?>
		</div>
	</div>
	<div class="wst-shop-eva">
		<p>服务评分</p>
		<div class="wst-shop-evai">
		<?php $__FOR_START_892072105__=0;$__FOR_END_892072105__=$data['shop']['scores']['serviceScore'];for($i=$__FOR_START_892072105__;$i < $__FOR_END_892072105__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_114115194__=1;$__FOR_END_114115194__=6-$data['shop']['scores']['serviceScore'];for($i=$__FOR_START_114115194__;$i < $__FOR_END_114115194__;$i+=1){ ?>
			<img src="__STATIC__/plugins/raty/img/star-off.png">
		<?php } ?>
		</div>
	</div>
	<div class="wst-shop-con">
		<p>电话：<?php echo $data['shop']['shopTel']; ?></p>
		<p>QQ：<?php echo $data['shop']['shopQQ']; ?></p>
		<p>服务时间：<?php echo date("H:i",strtotime($data['shop']['serviceStartTime'])); ?>-<?php echo date("H:i",strtotime($data['shop']['serviceEndTime'])); ?></p>
	</div>
	<div class="wst-clear"></div>
</div>
