<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/admin/view/areas/list.html";i:1523419924;s:74:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/admin/view/base.html";i:1509883698;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<div id='areasBox' style='display:none'>
  ...
  <table class='wst-form wst-box-top'>
     <tr>
        ...
        <td><input type='text' id='areaName' name="areaName" class='ipt' maxLength='60' style='width:200px;' onblur='javascript:letterOnblur(this)'/></td>
     </tr>
     <tr>
