<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:89:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/deals_detail.html";i:1524761168;s:81:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/base.html";i:1524761168;s:83:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/header.html";i:1524761168;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/header_top.html";i:1524761168;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/shop_apply.html";i:1524761168;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/right_cart.html";i:1524761168;s:83:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/footer.html";i:1524761168;}*/ ?>
<!doctype html>
<head>
          ...
          <!-- <div class="goods-pics">
            ...
            <div class="items">
               ...
               <?php if(is_array($goods['gallery']) || $goods['gallery'] instanceof \think\Collection): $i = 0; $__LIST__ = $goods['gallery'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                   <li><img title="<?php echo $goods['goodsName']; ?>" alt="<?php echo $goods['goodsName']; ?>" class='cloudzoom-gallery' src="__ROOT__/<?php echo WSTImg($vo); ?>" data-cloudzoom="useZoom: '.cloudzoom', image:'__ROOT__/<?php echo $vo; ?>', zoomImage:'__ROOT__/<?php echo $vo; ?>' " width="60" height="60"></li>
							 <?php endforeach; endif; else: echo "" ;endif; ?>
						 </ul>
					 </div>
         </div> -->
      ...
      <div class='intro'>
          ...
          <div class='summary'>
             ...
             <div class='item'>
               ...
               <div class='dd'>
		        <?php $__FOR_START_1177308941__=0;$__FOR_END_1177308941__=$goods['scores']['totalScores'];for($i=$__FOR_START_1177308941__;$i < $__FOR_END_1177308941__;$i+=1){ ?>
					<img src="__STATIC__/plugins/raty/img/star-on.png">
				<?php } $__FOR_START_1208211073__=1;$__FOR_END_1208211073__=6-$goods['scores']['totalScores'];for($i=$__FOR_START_1208211073__;$i < $__FOR_END_1208211073__;$i+=1){ ?>
			    ...
			    <div class="wst-tab-content" style='width:99%;margin-bottom: 10px;min-height:1312px;'>
				   ...
				   <div>
					  <iframe
						  ...
						  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAMIxb82Lk3jNlQ-LSxfCRMUTgV9BbRDdA&q=<?php echo $shop['shopAddress']; ?>+<?php echo $shop['shopSuburb']; ?>+<?php echo $shop['shopState']; ?>+<?php echo $shop['shopPostCode']; ?>" allowfullscreen>
					  </iframe>
				  </div>
			       </div>
