     ...
     <div class="dorp-down-layer">
		...
		<ul class="area-box" id="fl_1_3_pl">
	      ...
	      <div class='line line2'>
			...
			<button class="wst-price-but" type="submit" style="width:60px;height: 23px;margin-left:20px;" onclick='javascript:goodsOrder()'>确定</button>
