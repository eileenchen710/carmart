...
<div id='tab' class="wst-tab-box">
    ...
    <div class="wst-tab-content" style='width:99%;margin-bottom: 10px;border:0px;'>
      <form id='editform' autocomplete='off'>
        ...
        <style>
.webuploader-pick {background: #3b4e56 none repeat scroll 0 0;}
</style>
  ...
  <tr>
     ...
     <td colspan='2'>
      <div class="checkbox-box">
        <label>
	        <input id="isRecom" name='isRecom' class="j-ipt wst-checkbox" <?php if($object['isRecom']==1): ?>checked<?php endif; ?> value="1" type="checkbox"/><label class="mt-1" for="isRecom"></label>保养
	    </label>
	    <label>
	    ...
	    <label>
	        <input id="isNew" name="isNew" class="j-ipt wst-checkbox" <?php if($object['isNew']==1): ?>checked<?php endif; ?> value="1" type="checkbox"/><label class="mt-1" for="isNew"></label>美容
	    </label>
	    <label>
	        <input id="isHot" name="isHot" class="j-ipt wst-checkbox" <?php if($object['isHot']==1): ?>checked<?php endif; ?> value="1" type="checkbox"/><label class="mt-1" for="isHot"></label>轮胎
	    </label>
     </td>
   </div>
  </tr>
...
.wst-batchupload .placeholder .webuploader-pick {
    background: #3b4e56 none repeat scroll 0 0;
}
