   ...
   <div class="nav-w" style="position: relative;">
      ...
      <div id="wst-nav-items">
           <ul>
               ...
               <li class="fore1">
                    <a href="{{WST.U('home#c<?php echo $l-1; ?>')}}"><?php echo $vo['navTitle']; ?></a>
               </li>
               <?php endforeach; endif; else: echo "" ;endif; ?>
