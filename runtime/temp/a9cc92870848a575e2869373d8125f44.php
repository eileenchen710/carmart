...
<table class='wst-form wst-box-top'>
 ...
 <?php endif; ?>
  ...
  <tr>
     ...
     <td><input type="text" id='telephone' class='ipt' value="<?php echo $object['telephone']; ?>" maxLength='11' data-rule="店主联系手机: required;mobile" data-rule-mobile="[/^0[4]\d{8}$/, '请检查手机号格式']"/></td>
  </tr>
  <tr>
  ...
  <tr>
     ...
     <td><input type="text" id='shopSuburb' class='ipt' style='width:200px;' value="<?php echo $object['shopSuburb']; ?>" maxLength='20' data-rule="店铺区域: required;"/></td>
  </tr>
  <tr>
     <th>州<font color='red'>*</font>：</th>
     <td><input type="text" id='shopState' class='ipt' style='width:100px;' value="<?php echo $object['shopState']; ?>" maxLength='10' data-rule="州: required;"/></td>
  </tr>
  <tr>
     <th>邮编<font color='red'>*</font>：</th>
     <td><input type="text" id='shopPostCode' class='ipt' style='width:100px;' value="<?php echo $object['shopPostCode']; ?>" maxLength='10' data-rule="邮编: required;"/></td>
  ...
  <tr>
      ...
      <td>
            <iframe id = "googleMap"
                width="400"
                height="300"
                frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAMIxb82Lk3jNlQ-LSxfCRMUTgV9BbRDdA&q=<?php echo $object['shopAddress']; ?>+","+<?php echo $object['shopSuburb']; ?>+","+<?php echo $object['shopState']; ?>+","+<?php echo $object['shopPostCode']; ?>" allowfullscreen>
            </iframe>
       </td>
   </tr>
...
<script>
$(function(){initEdit({serviceStartTime:'<?php echo date("H:i",strtotime($object["serviceStartTime"])); ?>',serviceEndTime:'<?php echo date("H:i",strtotime($object["serviceEndTime"])); ?>'});})
</script>
<script>
    function showinmap(){
