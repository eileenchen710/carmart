<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/admin/view/shops/edit.html";i:1523511712;s:74:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/admin/view/base.html";i:1509883698;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<table class='wst-form wst-box-top'>
 ...
 <?php endif; ?>
  ...
  <tr>
     ...
     <!-- <td><button onclick="showinmap()">Click me</button></td> -->
  </tr>
  <!-- <tr>
  ...
  <tr>
      ...
      <td>
            <iframe
                width="400"
                height="300"
                frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAMIxb82Lk3jNlQ-LSxfCRMUTgV9BbRDdA&q=USYD" allowfullscreen>
            </iframe>
       </td>
   </tr>
...
<!-- <script>
    function showinmap(){
                ...
                window.alert(WST.ITGetAreaVal('j-areas'));

        var vl = document.getElementById("area_0");
        var index = vl.selectedIndex;
        var val = vl.options[index].text;
        var address = document.getElementById("shopaddress");
        document.getElementById("address").innerHTML = document.getElementById("area_0").value;
    }
</script> -->
