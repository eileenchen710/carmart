<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:99:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/users/useraddress/edit.html";i:1509883698;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/users/base.html";i:1509883698;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/header_top.html";i:1509883700;s:87:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/shop_apply.html";i:1509883698;s:83:"/Applications/XAMPP/xamppfiles/htdocs/carmart/wstmart/home/view/default/footer.html";i:1509883700;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>首页-买家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<form id="useraddressForm" autocomplete="off" >
	<table class='wst-form' >
	  ...
	  <tr>
	      <th width='110'><font color='red'>*</font>详细地址：</th>
	          <td>
	              <input type="text" class="ipt" id="userAddress" name="userAddress" value="<?php echo $data['userAddress']; ?>" placeholder="您的详细地址" maxlength="30" />
	          </td>
	   </tr>
	     ...
	     <tr>
	        ...
	        <td>
	        	<input type="text" class="ipt" id="userName" name="userName" value="<?php echo $data['userName']; ?>" placeholder="联系名称" maxlength="6" />
	        </td>
	     </tr>
	        ...
	        <tr>
	          ...
	          <td>   
	              <input type="text" class="ipt contact" id="userPhone" name="userPhone" value="<?php echo $data['userPhone']; ?>"  placeholder="联系电话" >
	          </td>
	       </tr>
	       <tr>
	...
	<div class="addr-btn-box">
	       <input type="hidden" name="id" id="addressId" class="ipt" value="<?php echo $data['addressId']; ?>" />
...
$(function(){
	//默认选中下拉框
	if($('#addressId').val()>0){
	    var areaIdPath = "<?php echo $data['areaIdPath']; ?>".split("_");
...
<div class="wst-footer-help">
	...
	<script type='text/javascript' src='__STYLE__/users/useraddress/useraddress.js?v=<?php echo $v; ?>'></script>
	<script type="text/javascript" src="__STATIC__/plugins/validator/jquery.validator.js?v=<?php echo $v; ?>"></script>
	<script type="text/javascript" src="__STATIC__/plugins/validator/local/zh-CN.js?v=<?php echo $v; ?>"></script>
